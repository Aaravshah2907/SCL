...
% the Raspberry Pi(R) hardware as a standalone executable using MATLAB(R) Support Package
...
% <<../edge_detection.png>>
%
% You can also deploy the Edge detection function from MATLAB(R)
% Online(TM). See
% <docid:mlsupportpkg.mw_37fe1f7c-380a-4205-8f06-8dfdb9683f20 Connect
% to Raspberry Pi Hardware Board in MATLAB Online> to connect to the
% Raspberry Pi hardware to MATLAB Online, and deploy the MATLAB function.
%
% For a brief overview on this example, see the
% <https://www.mathworks.com/videos/deploy-an-edge-detection-algorithm-on-raspberry-pi-1591967219707.html
% Deploy an Edge Detection Algorithm on the Raspberry Pi Hardware> video.
%
...
%% Required Products
% 
% * Raspberry Pi hardware. Ensure the hardware is connected to the internet, when working on MATLAB&reg; Online&trade;.
% * A supported <https://elinux.org/RPi_USB_Webcams USB webcam> or a
% <https://www.raspberrypi.com/products/camera-module-v2/ Raspberry Pi camera module>
...
% |<docid:mlsupportpkg#bve3b92 displayImage>| function provided by 
...
%
% *Note*: You can deploy the edge detection algorithm from MATLAB(R)
% Online&trade;. See
% <docid:mlsupportpkg.mw_37fe1f7c-380a-4205-8f06-8dfdb9683f20 Connect
...
%
% * <docid:mlsupportpkg.mw_37fe1f7c-380a-4205-8f06-8dfdb9683f20 Connect
% to Raspberry Pi Hardware Board in MATLAB Online>
