...
servoIncrement   = 0.5;        % Rate at which the position of servo should change
servoPinNumber   = 12;         % GPIO12 for servo control
servoPos         = 90;         % Initial position of the servo motor
MinPulseDuration = 0.5e-3;     % Minimum pulse duration for the servo motor
MaxPulseDuration = 2.5e-3;     % Maximum pulse duration for the servo motor
