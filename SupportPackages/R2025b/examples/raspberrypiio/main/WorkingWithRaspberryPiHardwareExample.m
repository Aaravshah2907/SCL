...
%
% This example shows basics of how to work with Raspberry Pi(R) Hardware.
...
% package includes MATLAB(R) command-line interfaces to communicate with
...
%% Prerequisites
%
% * It is helpful to complete the <docid:mlsupportpkg.example-raspi_gettingstarted  Getting Started with MATLAB Support Package for Raspberry Pi Hardware>
% example.
...
% use showPins() method of the raspi object.
%
%   rpi = raspi();
%   showPins(rpi);
%
