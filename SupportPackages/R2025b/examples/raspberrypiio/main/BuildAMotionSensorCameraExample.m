...
% 
% * <docid:mlsupportpkg.example-raspi_gettingstarted_with_hardware Getting Started with Raspberry Pi Hardware> example.
%
% * <docid:mlsupportpkg.example-raspi_working_with_camera_board Working with Raspberry Pi Camera Board> example.
...
% button instead. See <docid:mlsupportpkg.example-raspi_gettingstarted_with_hardware Getting Started with Raspberry Pi Hardware> example for details. 
...
%   imagesc(img);
%%%
% *Note*: You can also use the <docid:mlsupportpkg#bu6ial4 webcam> API to create a webcam object.
%
