...
%
% This example shows you how to use the serial UART on Raspberry Pi(R)
...
% in the <docid:mlsupportpkg#example-raspi_segmented_display_using_i2c Control a Four-Digit Seven-Segment Display Using I2C> example. However, this
...
% about MATLAB(R) command interface for serial communication devices and
...
% <docid:mlsupportpkg.example-raspi_gettingstarted Getting Started with MATLAB Support Package for Raspberry Pi Hardware> example. 
...
% control signals connecting between data terminal equipment (DTE) and 
...
%
% In the default Raspbian Linux(R) image, the serial port is configured
...
% control interface where the controller device, Raspberry Pi hardware in this
