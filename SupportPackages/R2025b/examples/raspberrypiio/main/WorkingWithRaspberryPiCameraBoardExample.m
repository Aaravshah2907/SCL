...
%% Prerequisites
%
% * We recommend completing <docid:mlsupportpkg.example-raspi_gettingstarted Getting Started with MATLAB Support Package for Raspberry Pi Hardware> example. 
...
%   end
%%%
% Note: FFmpeg is a third-party tool and any issues related to it are not
