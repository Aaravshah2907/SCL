%% Working with Raspberry Pi Sense HAT
%
...
% <docid:mlsupportpkg.example-raspi_gettingstarted Getting Started with
% MATLAB Support Package for Raspberry Pi Hardware> example.
...
% 
% |readJoystick| returns a value between 0 to 5 depending on the position of the joystick.
% 
% * 0 - Not pressed
% * 1 - Centre
% * 2 - Left
...
% LED matrix.  Let us set the color of the pixel in the 3rd column, 6th row
% to cyan.
% 
