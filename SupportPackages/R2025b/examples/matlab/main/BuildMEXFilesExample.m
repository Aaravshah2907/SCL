%% Build MEX Files
% Build MEX files using a task group created with the
% |matlab.buildtool.tasks.MexTask.forEachFile| method. You must have a 
% supported C compiler installed on your system to run this example.

% Copyright 2024 The MathWorks, Inc.

%% 
% Open the example and then navigate to the |mex_task_group_example| 
% folder, which contains a build file as well as two C source files named
...
% folder.
%
% <include>mex_task_group_example\buildfile.m</include>
%
%%
