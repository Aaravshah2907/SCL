...
%
% We will call the |trackBall| function on the images captured by the drone 
% in a loop. The |trackBall| function accepts the following inputs:
%    
...
% of the image.
%
% For more information on the |trackBall| function, open the |TrackGreenBallExample|
% and then execute the following command in the MATLAB command line:
%
     open('trackBall.m')
%
