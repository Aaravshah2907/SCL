...
%%
% Next, create a contour plot and specify the |LabelFormat| property as a
% handle to |mylabelfun|. Specify a partially transparent fill color by
% setting the |FaceAlpha| value to |0.25|.
