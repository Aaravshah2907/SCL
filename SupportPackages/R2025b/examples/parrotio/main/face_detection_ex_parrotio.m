...
% 
% This example shows how to use a Parrot&reg; drone to automatically detect human 
% faces captured by the drone's FPV camera. 
% 
%% Introduction
%
% Use the MATLAB&reg; Support Package for Parrot&reg; Drones to control the 
...
%
% * MATLAB&reg;
% * MATLAB&reg; Support Package for Parrot&reg; Drones
...
%
  parrotObj = parrot; 
%
%% Task 2 &mdash; Create a Cascade Object Detector Instance
%  
...
%
  ...
  moveup(parrotObj,1);   
%
%% Task 4 &mdash; Create a Connection to the Drone's FPV Camera
%
...
%
%% Task 5 &mdash; Detect Faces While Traversing a Square Path
% 
...
% forward step, ensuring a nonblocking behaviour. This enables the drone to 
