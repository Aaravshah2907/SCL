...
%% Introduction
%
% The MATLAB(R) Support Package for LEGO(R) MINDSTORMS(R) EV3 Hardware enables you
% to interact with LEGO MINDSTORMS EV3 hardware from within MATLAB.
% 
% This example shows you how to set up communications with the EV3 brick
% over a USB, Wi-Fi(R), or Bluetooth(R) connection. Then, verify that you can use
...
% information, see
% <docid:mlsupportpkg#example-ev3io_basic Interact with EV3 Brick Peripherals, Read Sensor Values, and Control Motors> example.
