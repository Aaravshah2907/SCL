...
% to make a two-wheel LEGO(R) MINDSTORMS(R) EV3 vehicle drive straighter. 
...
%
% Complete both 
% <docid:mlsupportpkg.example-ev3io_gettingstarted Getting Started with MATLAB Support Package for LEGO MINDSTORMS EV3 Hardware>  
% and
% <docid:mlsupportpkg.example-ev3io_basic Interact with EV3 Brick Peripherals, Read Sensor Values, and Control Motors> examples. 
%
...
%% Summary
% 
% This example demonstrates the implementation of motor control for two-wheel EV3 vehicle. You learned that:
%
